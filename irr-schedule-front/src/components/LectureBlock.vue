<template>
    <div class="uk-card lecture-card">
      <div class="uk-card-body">
        <!-- Дата -->
        <h3 class="uk-card-title">{{ formattedDate }}</h3>
        ...
        <ul class="uk-list button-list">
          <li>
            <button class="uk-button uk-button-primary custom-button" @click="openDay">
              <span uk-icon="calendar" class="uk-margin-small-right"></span>
              Расписание
            </button>
          </li>
          <li>
            <button class="uk-button uk-button-secondary custom-button" @click="connect">
              <span uk-icon="link" class="uk-margin-small-right"></span>
              Подключение
            </button>
          </li>
        </ul>
  ...
  export default {
    ...
    computed: {
      formattedDate() {
        return this.data.date.toUpperCase();
      },
      formattedGroups() {
