    ...
    <div class="uk-card uk-card-default uk-card-body uk-width-1-3@m">
      ...
      <form @submit.prevent="handleLogin">
        <div class="uk-margin">
          ...
          <input v-model="username" class="uk-input" id="username" type="text" placeholder="Имя пользователя" required />
        </div>
        <div class="uk-margin">
          <label class="uk-form-label" for="password">Пароль</label>
          <input v-model="password" class="uk-input" id="password" type="password" placeholder="Пароль" required />
        </div>
        <div class="uk-margin">
